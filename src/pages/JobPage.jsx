...
export default function JobPage({ jobs, onSave, pendingTasks = [] }) {
  ...
  // Buscar si hay tarea pendiente para ESTE trabajo
  ...
  useEffect(() => {
    if (job) {
      setFormData({
        ...
        notes: job.notes || '', tech_stack: job.tech_stack || '', message_drafts: job.message_drafts || '', 
        ai_summary: job.ai_summary || '', ai_requirements: job.ai_requirements || '', ai_benefits: job.ai_benefits || ''
      });
    }
  }, [job]);
